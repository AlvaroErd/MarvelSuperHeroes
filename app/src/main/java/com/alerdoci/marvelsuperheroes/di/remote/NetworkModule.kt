...
import com.alerdoci.marvelsuperheroes.data.features.superheroes.factory.SuperHeroesDataFactory
import com.alerdoci.marvelsuperheroes.data.features.superheroes.remote.implement.SuperHeroesRemoteImplementFactory
...
//        return SuperHeroesRemoteDataStoreImpl(remoteService)
//    }

    @Provides
    fun providesSuperHeroesRepository(factory: SuperHeroesDataFactory): MarvelRepository = SuperHeroesRemoteImplementFactory(factory)
